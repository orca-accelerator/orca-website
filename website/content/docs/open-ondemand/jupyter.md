...
![Links for 'Jupyter Lab and 'Jupyter Notebook' are listed under the 'Interactive Apps' tab on the Open OnDemand start page.](orca-jupyter-notebook-small-01.png)
...
![Kernels are found under the 'Notebook' header at the top of the 'Launcher' tab.](orca-jupyter-lab-small-01.png)
